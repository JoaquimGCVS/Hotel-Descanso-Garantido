...
void cadastrarQuarto(Quarto quarto[], int *numQuarto) {
  ...
  novoQuarto.valorDiaria = 100;

  novoQuarto.qtdHospede = 3;
...
void cadastrarFuncionario(Funcionario funcionario[], int *numFuncionario) {
  ...
  strcpy(novoFuncionario.nome, "jose" );
  
  strcpy(novoFuncionario.telefone , "31989898989");

  strcpy(novoFuncionario.cargo , "Gerente");

  novoFuncionario.salario = 10.000;
